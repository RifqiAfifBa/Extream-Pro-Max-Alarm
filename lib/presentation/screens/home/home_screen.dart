...
class _HomeScreenState extends ConsumerState<HomeScreen>
  ...
  void _checkAlarms() {
    ...
    for (final alarm in alarms) {
      ...
      if (alarm.repeatDays.isNotEmpty && !alarm.repeatDays.contains(today)) continue;
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Stack(
                    children: [
                      GestureDetector(
                        onTap: () => context.push('/alarm-ringing', extra: nextAlarm),
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(
                            color: AppColors.border, width: 1, style: BorderStyle.solid),
                      ),
                      child: Column(
                        children: [
                          Container(
                      ...
                      return TweenAnimationBuilder<double>(
                        ...
                        child: Padding(
                          ...
                          child: AlarmCard(
                            ...
                            onTap: () => context.push('/add-alarm', extra: alarm),
                          ),
                        ),
                      );
                    },
